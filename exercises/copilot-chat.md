...
```
ร่างอีเมลล์ถึงคุณสมศรี เรื่องการขอนัดคุยเรื่องการเปิดตัวเครื่องซักผ้าปี 2026 โดยอยากนัดเวลา 10.00 น.
```
...
```
หาข่าวที่เกี่ยวกับ [องค์กร] ที่สำคัญในปี 2025
```
...
```
สร้างรูปภาพของครอบครัว มีพ่อ แม่ ลูก ช่วยกันทำความสะอาดบ้าน
```
...
```
เปลี่ยนฉากหลังเป็นห้างสรรพสินค้า
```

5. ตรวจสอบผลลัพธ์
6. นำ Mouse Cursor มาชี้ที่รูป และกดปุ่มบันทึกรูปภาพไปใช้งาน
