...
2. จากนั้นพิมพ์ "/" เพื่อเรียกหน้าจอ attach ไฟล์ ให้ค้นหา และเลือกไฟล์ `TML_Word_OpsReport_Source.docx` ที่เราอัพโหลดไว้ใน OneDrive

3. copy prompt ต่อไปนี้ไปวางต่อใน prompt box และกดปุ่ม Generate

```
ร่าง "รายงานสรุปผู้บริหาร" ความยาว 1–2 หน้า
โครงต้องมี: Executive summary (5 bullets) / KPI highlights (new policy, persistency, claim turnaround time, complaint) / Issues & root causes / 2-week mitigation plan (owner+due) / Requests to leadership
ภาษาไทย ทางการ กระชับ อ่านง่าย เหมาะสำหรับผู้บริหารของ Tokio Marine Life Thailand
```
...
## Step 3: ปรับคุณภาพภาษาให้ทางการและกระชับ
...
2. ตั้งชื่อไฟล์ใหม่: `TML_OpsReport_ExecutiveSummary.docx`
