...
2. เตรียมไฟล์ `TML_OpsReport_ExecutiveSummary.docx` ไว้ใน OneDrive
...
## Step 2: สร้าง Presentation จากเนื้อหาไฟล์ (สำหรับผู้ใช้ที่มี License)
   ...
   3. ค้นหาไฟล์ **TML_OpsReport_ExecutiveSummary.docx** ที่เราบันทึกไว้ใน exercise ที่แล้ว และเลือกไฟล์ เพื่อใส่ลงไปใน prompt
