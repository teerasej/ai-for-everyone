...
# Exercise 4 — Daily Communication ด้วย Copilot in Outlook + Teams
...
3. กรอกหัวข้ออีเมลล์ 
    ```
    ปัญหาส่งของล่าช้า DC-บางบัวทอง วันที่ 18 ก.พ.
    ```
...
5. เลือกคำสั่ง prompt 1 อย่างจากรายการต่อไปนี้ วางลงในกล่อง Prompt box และกดปุ่ม Generate
   ...
   ```
   ทีมร้านแจ้ง: ของมาถึงช้ากว่าปกติ 2 ชม. ทำให้เติมสินค้าไม่ทัน
   ```
   ```
   ทีมขนส่งแจ้ง: รถขาด 1 คัน + รถติดเส้นทางหลัก
   ```
   ```
   ทีม DC แจ้ง: จุดคัดแยกคอขวดช่วง 17:00–19:00
...
```
ช่วยร่างข้อความประกาศให้ทีมปฏิบัติการ 5 บรรทัด โทนชัดเจน สุภาพ
```
