...
3. กรอกหัวข้ออีเมลล์ 
    ```
    ปัญหา conversion lead ลดลง ช่องทางธนาคาร เดือน เม.ย.
    ```
...
5. เลือกคำสั่ง prompt 1 อย่างจากรายการต่อไปนี้ วางลงในกล่อง Prompt box และกดปุ่ม Generate
   ...
   ```
   ทีมบริการลูกค้าแจ้ง: ลูกค้าร้องเรียนเรื่องเอกสารเคลมไม่ครบเพิ่มขึ้น 18% จำเป็นต้องมี checklist เอกสารก่อนยื่น
   ```
   ```
   ทีมขายแจ้ง: lead ธนาคารเข้ระบบ 1,680 ราย แต่ conversion ลดจาก 18% เหลือ 14% ขอแผน follow-up playbook
   ```
   ```
   ทีมพิจารณารับประกันแจ้ง: claim turnaround time เพิ่มจาก 4.2 วัน เป็น 5.1 วัน เคลมค้าง  28 ราย
