...
3. ลงมาที่ส่วนของ Capabilities และเลือกเปิดการทำงานของ Code Capabilities เพื่อให้ทำการคำนวนพื้นฐานได้

4. จากด้านบนหน้าจอ Create Agent ให้เลือกเปิด **Try it**  และกดปุ่ม **New Chat** เพื่อให้เนื้อหาไม่ปนกัน 
5. ทดสอบคุยด้วย prompt ต่อไปนี้
    ```
...
6. จะสังเกตการทำงานได้ว่าสามารถตอบเงื่อนไขได้มากกว่าเดิม
